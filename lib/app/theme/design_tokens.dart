...
class Spacing {
  ...
  /// Figma: rehearsal card height 111px
  static const double rehearsalCardHeight = 111.0;
...
class AppColors {
  ...
  // Primary accent - Figma: rose-500 #f43f5e
...
/// Typography styles - Figma SF Pro specs
class AppTextStyles {
  AppTextStyles._();

  // Figma: Title3/Emphasized - 20px, weight 590, line-height 25px, letterSpacing -0.45px
  ...
  // Figma: Headline/Regular - 17px, weight 590, line-height 22px, letterSpacing -0.43px
  ...
  // Figma: Callout/Regular - 16px, weight 400, line-height 21px, letterSpacing -0.31px
  ...
  // Figma: Callout/Emphasized - 16px, weight 590, line-height 21px, letterSpacing -0.31px
  ...
  // Figma: Footnote/Emphasized - 13px, weight 590, line-height 18px, letterSpacing -0.08px
  ...
  // Figma: Nav label - 11px, weight 590, line-height 12px, letterSpacing -0.1px
