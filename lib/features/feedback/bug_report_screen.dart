...
class _BugReportScreenState extends State<BugReportScreen> {
  ...
  Future<void> _submitFeedback() async {
    ...
    switch (result) {
      ...
      case BugReportEmailAppNotFound(:final message, :final reportText):
      ...
      case BugReportLaunchFailed(:final message, :final reportText):
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Report Bugs', style: AppTextStyles.title3),
        leading: IconButton(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: Spacing.space12),
          Text(
            'You can copy the report and email it manually to ${BugReportEmailService.recipientEmail}',
            style: AppTextStyles.footnote.copyWith(
              color: AppColors.textSecondary,
            ),
          ),
