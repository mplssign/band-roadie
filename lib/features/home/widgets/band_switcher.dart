...
class _BandSwitcherTokens {
  ...
  // Selected band row - prominent gradient + visible top/bottom borders
  static const Color selectedGradientTop = Color(0xFF2D2D2D);
  static const Color selectedGradientBottom = Color(0xFF1A1A1A);
  static const Color selectedBorderTop = Color(0xFF4A4A4A);
  static const Color selectedBorderBottom = Color(0xFF1A1A1A);
    ...
    return GestureDetector(
      ...
      child: AnimatedBuilder(
        ...
        child: Column(
          ...
          children: [
            // Selected state: subtle gradient background with top/bottom borders
              ...
              decoration: BoxDecoration(
                ...
                gradient: widget.isActive
                    ? const LinearGradient(
                        ...
                        colors: [
                          _BandSwitcherTokens.selectedGradientTop,
                          _BandSwitcherTokens.selectedGradientBottom,
                        ],
                      )
                    : null,
                border: widget.isActive
                    ? const Border(
                        top: BorderSide(
                          color: _BandSwitcherTokens.selectedBorderTop,
                          width: 1,
                        ),
                        bottom: BorderSide(
                          color: _BandSwitcherTokens.selectedBorderBottom,
                          width: 1,
                        ),
                      )
                    : null,
