...
class _LoginScreenState extends State<LoginScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      // Prevent resize when keyboard opens - we handle it manually
      resizeToAvoidBottomInset: false,
      body: SafeArea(
        child: LayoutBuilder(
          builder: (context, constraints) {
            // CENTERING STRATEGY:
            // - LayoutBuilder provides available height
            // - SingleChildScrollView with ConstrainedBox ensures scrollable on tiny screens
            // - Center widget centers the content cluster
            // - AnimatedPadding at bottom lifts content when keyboard opens

            return AnimatedPadding(
              // Lift content by half the keyboard height for iOS-style centering
              // This keeps the input roughly centered in the visible area
              ...
              child: SingleChildScrollView(
                ...
                child: ConstrainedBox(
                  // Ensure content takes at least full available height (minus keyboard lift)
                    ...
                    child: Padding(
                      ...
                      child: AnimatedBuilder(
                        ...
                        builder: (context, _) => _buildContentCluster(
                          ...
                          maxWidth:
                              constraints.maxWidth - 64, // Account for padding
                        ),
                      ),
                    ),
                  ),
  ...
  Widget _buildContentCluster({
    ...
    return Column(
      ...
      children: [
        ...
        // === DOMAIN PILLS ===
        // Pills row is constrained to same width as email field for alignment
