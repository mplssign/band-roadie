...
class _DayCell extends StatelessWidget {
  ...
  /// Order (top to bottom): Block Out (rose), Gig (green), Rehearsal (blue)
  Widget _buildMarkerStack() {
    final activeMarkers = <Color>[];

    // Add markers in order: blockout, gig, rehearsal
    if (hasBlockOut) activeMarkers.add(CalendarColors.blockOutIndicator);
    if (hasGig) activeMarkers.add(CalendarColors.gigIndicator);
    if (hasRehearsal) activeMarkers.add(CalendarColors.rehearsalIndicator);
